    ...
    public function run()
    {
        DB::table('product')->insert(array(
            ...
            array(
                ...
                'price' => '222000',
                'discount' => 22,
                'genre' => json_encode(array('11', '6', '12', '13')),
                'age' => 2,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ),
            ...
            array(
                ...
                'price' => '900000',
                'discount' => 0,
                'genre' => json_encode(array('17', '18', '19', '3')),
                'age' => 3,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ),
            array(
                ...
                'price' => '1200000',
                'discount' => 20,
                'genre' => json_encode(array('1', '11', '17', '3')),
                'age' => 3,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ),
            ...
            array(
                ...
                'price' => '120000',
                'discount' => 7,
                'genre' => json_encode(array('16', '22', '10', '23', '24')),
                'age' => 3,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ),
            ...
            array(
                ...
                'price' => '400000',
                'discount' => 5,
                'genre' => json_encode(array('29', '32', '30', '31')),
                'age' => 1,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ),
